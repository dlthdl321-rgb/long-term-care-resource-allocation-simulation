...
> **문서 상태: 이전 분석범위의 생성 보고서.** 전국 229개 지역×39개 기관유형을 사용한 과거 결과이며 현재 76개 군×3개 서비스의 대표 결과가 아닙니다. 현재 분석 기준은 [분석방법론](../01_분석방법론.md)을 참고하세요.
...
| 레거시 보고서 생성 | [generate_statistical_report.py](../../04_분석코드/archive/generate_statistical_report.py) | 과거 결과를 보고서로 변환하던 보존 도구 |
