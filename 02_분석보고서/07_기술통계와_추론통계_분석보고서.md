...
> **문서 상태:** 이 보고서는 전국 229개 분석지역×39개 기관유형을 사용한 기존 기초검증 결과다. 최신 연구범위인 도 소속 농촌 군×방문요양·방문간호·주야간보호의 Q1~Q3 결과가 아니며, 최신 데이터셋·지표·시뮬레이션 정의는 [데이터 기반 분석기획](06_데이터기반_분석기획.md)을 기준으로 한다. 세 서비스 코드 매핑과 2024년 이용-공급 시점 정합화를 마친 뒤 최종 분석보고서로 대체해야 한다.
